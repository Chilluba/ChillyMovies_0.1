        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="flex max-h-[90vh] flex-col gap-6 p-6">
            ...
            <div className="flex-1 overflow-y-auto">
              <h3 className="mb-4 font-medium text-white">Select Episodes</h3>
              <div className="flex flex-col gap-4">
                      ...
                      >
                        ...
                        {isLoading ? (
                          ...
                          <svg
                            ...
                            stroke="currentColor"
                            strokeWidth="2"
                            className={`transform text-white transition-transform ${isExpanded ? 'rotate-180' : ''}`}
                          >
                      ...
                      {isExpanded && seasonWithEpisodes?.episodes && (
                        <div className="mt-4 flex flex-col gap-2">
                          {seasonWithEpisodes.episodes.map((episode) => (
                            <label
                              key={episode.id}
                              className="flex cursor-pointer items-center gap-3 rounded-lg border border-secondary p-3 hover:border-white"
                            >
                              <input
                                type="checkbox"
